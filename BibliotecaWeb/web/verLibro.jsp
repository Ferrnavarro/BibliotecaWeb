...
<jsp:setProperty name="libro" property="idlibro" param="id"/>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="page-header">Datos de los libros</h3>
                        ...
                        <c:if test="${!empty param.btnEnviar}">
                            ...
                            <c:if test="${libro.lleno}">
                                ...
                                <c:choose>
                                    <c:when test="${existe}">
                                        <c:set var = "modif" value = "${libro.getModiff(libro.idlibro)}"/>
                                        <c:choose>
                                            <c:when test="${modif}">
                        ...
                        <c:choose>
                            <c:when test="${existe}">
                                <form class="form-horizontal" role="form" action="verLibro.jsp?id=${libro.idlibro}" method="POST">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="iddocumento" id="iddocumento" 
                                                       value="${libro.retornariddoc(libro.idlibro)}" placeholder="Edicion" required/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="isbn" id="isbn" 
                                                       value="${libro.retornarisbn(libro.idlibro)}"  required/>
                                            </div>
                                        </div>
                            ...
                            <c:when  test="${!existe}">
                                <input type="text" class="form-control" name="idlibro" id="txtID" 
                                                       value="${documentos.iddocumento}" placeholder="ID" readonly/>
                                <div class="alert alert-danger">No se encontró el Documento. <a href="libros.jsp" class="alert-link">Regresar</a></div>
                            </c:when>
                        </c:choose>
                    </div>
                    <!-- /.col-lg-12 -->
