...
<head>
    ...
    <title>Mantenimiento Revistas</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-header">Mantenimiento Revistas</h2>

                        <h3 class="sub-header">Listado de Revistas 
                            <a  class="btn btn-info btn-xs" href="nuevaRevista.jsp">Nueva Revista <i class="fa fa-plus-circle"></i></a>
                        </h3>
                        
                        <c:if test="${!empty param.eliminar}">
                            <jsp:setProperty name="revistas" property="idRevista" param="eliminar"/>
                            ...
                            <c:if test="${existe}">
                                <c:set var = "eliDoc" value = "${revistas.eliminar}"/>
                                <c:choose>
                                    <c:when test="${eliUser}">
                        ...
                        <div class="table-responsive">
                            <jsp:include page="listarRevistas.jsp"/>
                        </div>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
