...
<head>
    ...
    <title>Mantenimiento Dvds</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-header">Mantenimiento DVDs</h2>

                        <h3 class="sub-header">Listado de DVDs 
                            <a  class="btn btn-info btn-xs" href="nuevodvd.jsp">Nuevo DVD <i class="fa fa-plus-circle"></i></a>
                        </h3>
                        
                        <c:if test="${!empty param.eliminar}">
                            <jsp:setProperty name="dvd" property="iddvd" param="eliminar"/>
                            ...
                            <c:if test="${existe}">
                                <c:set var = "eliDoc" value = "${dvd.eliminar}"/>
                                <c:choose>
                                    <c:when test="${eliUser}">
