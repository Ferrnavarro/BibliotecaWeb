...
<head>
    ...
    <title>Mantenimiento Ejemplar</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-header">Mantenimiento Ejemplar</h2>

                        <h3 class="sub-header">Listado de Ejemplares 
                            <a  class="btn btn-info btn-xs" href="nuevoEjemplar.jsp">Nuevo Ejemplar <i class="fa fa-plus-circle"></i></a>
                        </h3>
                        
                        <c:if test="${!empty param.eliminar}">
                            <jsp:setProperty name="ejemplar" property="idejemplar" param="eliminar"/>
                            ...
                            <c:if test="${existe}">
                                <c:set var = "eliDoc" value = "${ejemplar.eliminar}"/>
                                <c:choose>
                                    <c:when test="${eliUser}">
                        ...
                        <div class="table-responsive">
                            <jsp:include page="listarEjemplar.jsp"/>
